I fixed the margin of the contact form for smaller widths, centered my headshot, added a border between the different sections all to make it look visually cleaner.
